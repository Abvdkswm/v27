...
let handler = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    //conn.sendHydrated(m.chat, text.trim(), conn.getName(conn.user.jid), await genProfile(conn, m), 'https://www.facebook.com/frel.frel.908132', 'Facebook', null, null, [['Speedtest', _p + 'ping'], ['Owner', _p + 'owner']], m)
   ...
   conn.sendButton(m.chat, `*${wish()}, ${name} 👋*`, text.trim(), await genProfile(conn, m), [['Speedtest', _p + 'ping'], ['Owner', _p + 'owner']], false, { quoted: fkon, contextInfo: { externalAdReply: { showAdAttribution: true,
    mediaUrl: "https://www.facebook.com/frel.frel.908132",
    mediaType: "VIDEO",
    description: "https://www.facebook.com/frel.frel.908132", 
